...
def run(
    ...
    """Run nesting from a CSV file (format: filename, width, height, count)."""
    try:
        require_platform()
            ...
            with open(csv_path, newline="") as f:
                ...
                for row_num, row in enumerate(reader, 2):
                    ...
                    try:
                        ...
                        console.print(
                            f"[yellow]Warning:[/yellow] Skipping row {row_num}: invalid data"
                        )
                        continue
        ...
        console.print(f"[red]Nesting error:[/red] {e}")
        raise typer.Exit(code=1) from e
